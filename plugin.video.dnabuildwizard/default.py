...
base='http://www.morphstation.com'
ADDON=xbmcaddon.Addon(id='plugin.video.dnabuildwizard')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/wFTbQGLcJXbrOq1U').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("dnaBUILD Wizard","Downloading ",'', 'Please Wait')
